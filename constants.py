...
lst = [('бАнты', 'бантЫ', 'noun'), ('крАны', 'кранЫ', 'noun'), ('новостЕй', 'нОвостей', 'noun'), ('водопровОд', 'водопрОвод', 'noun'), ('каталОг', 'катАлог', 'noun'), ('аэропОрты', 'аэропортЫ', 'noun'), ('киломЕтр', 'килОметр', 'noun'), ('докумЕнт', 'докУмент', 'noun'), ('мЕстностей', 'местностЕй', 'noun'), ('бОроду', 'бородУ', 'noun'), ('дефИс', 'дЕфис', 'noun'), ('знАчимость', 'значИмость', 'noun'), ('Иксы', 'иксЫ', 'noun'), ('лыжнЯ', 'лЫжня', 'noun'), ('вероисповЕдание', 'вероисповедАние', 'noun'), ('мусоропровОд', 'мусоропрОвод', 'noun'), ('еретИк', 'ерЕтик', 'noun'), ('газопровОд', 'газопрОвод', 'noun'), ('кремнЯ', 'крЕмня', 'noun'), ('чЕлюстей', 'челюстЕй', 'noun'), ('пОчестей', 'почестЕй', 'noun'), ('децимЕтр', 'децИметр', 'noun'), ('сантимЕтр', 'сантИметр', 'noun'), ('кремЕнь', 'крЕмень', 'noun'), ('кОнусов', 'конусОв', 'noun'), ('исповЕдать', 'исповедАть', 'noun'), ('некролОг', 'некрОлог', 'noun'), ('намЕрение', 'намерЕние', 'noun'), ('корЫсть', 'кОрысть', 'noun'), ('монолОг', 'монОлог', 'noun'), ('диспансЕр', 'диспАнсер', 'noun'), ('жалюзИ', 'жАлюзи', 'noun'), ('нефтепровОд', 'нефтепрОвод', 'noun'), ('миллимЕтр', 'миллИметр', 'noun'), ('диалОг', 'диАлог', 'noun'), ('квартАл', 'квАртал', 'noun'), ('знАчимый', 'значИмый', 'noun'), ('бухгАлтеров', 'бухгалтерОв', 'noun'), ('договорЁнность', 'договОренность', 'noun'), ('граждАнство', 'грАжданство', 'noun'), ('лЕкторов', 'лекторОв', 'noun'), ('досУг', 'дОсуг', 'noun'), ('красИвейший', 'красивЕйший', 'adjective'), ('кУхонный', 'кухОнный', 'adjective'), ('болтлИва', 'болтливА', 'adjective'), ('оптОвый', 'Оптовый', 'adjective'), ('ловкА', 'лОвка', 'adjective'), ('мозаИчный', 'мозАичный', 'adjective'), ('смазлИва', 'смАзлива', 'adjective'), ('прожОрлива', 'прожорлИва', 'adjective'), ('слИвовый', 'сливОвый', 'adjective'), ('знАчимый', 'значИмый', 'adjective'), ('красИвее', 'красивЕе', 'adjective'), ('прозорлИва', 'прозОрлива', 'adjective'), ('суетлИва', 'суЕтлива', 'adjective'), ('вернА', 'вЕрна', 'adjective'), ('нАчал', 'начАл', 'verb'), ('надорвалАсь', 'надорвАлась', 'verb'), ('послАла', 'послалА', 'verb'), ('сорИт', 'сОрит', 'verb'), ('ворвалАсь', 'ворвАлась', 'verb'), ('обогналА', 'обогнАла', 'verb'), ('прибЫть', 'прИбыть', 'verb'), ('бралАсь', 'брАлась', 'verb'), ('взялАсь', 'взЯлась', 'verb'), ('воссоздалА', 'воссоздАла', 'verb'), ('клАла', 'клалА', 'verb'), ('принялА', 'прИняла', 'verb'), ('прИнял', 'принЯл', 'verb'), ('занялА', 'зАняла', 'verb'), ('жИться', 'житьсЯ', 'verb'), ('обнялАсь', 'обнЯлась', 'verb'), ('гналА', 'гнАла', 'verb'), ('добралА', 'добрАла', 'verb'), ('окружИт', 'окрУжит', 'verb'), ('нарвалА', 'нарвАла', 'verb'), ('отозвалА', 'отозвАла', 'verb'), ('плодоносИть', 'плодонОсить', 'verb'), ('ворвАться', 'ворватьсЯ', 'verb'), ('добралАсь', 'добрАлась', 'verb'), ('зАнял,', 'занЯл,', 'verb'), ('налилА', 'налИла', 'verb'), ('перезвонИть', 'перезвОнить', 'verb'), ('воспринЯть', 'воспрИнять', 'verb'), ('лИться', 'литьсЯ', 'verb'), ('прИняли', 'принЯли', 'verb'), ('баловАть', 'бАловать', 'verb'), ('принУдить', 'принудИть', 'verb'), ('создАть', 'сОздать', 'verb'), ('укрепИть', 'укрЕпить', 'verb'), ('чЕрпать', 'черпАть', 'verb'), ('началА', 'нАчала', 'verb'), ('взялА', 'взЯла', 'verb'), ('насорИть', 'насОрить', 'verb'), ('ободрИть', 'обОдрить', 'verb'), ('исчЕрпать', 'исчерпАть', 'verb'), ('перелилА', 'перелИла', 'verb'), ('разбаловАть', 'разбАловать', 'verb'), ('сорИть', 'сОрить', 'verb'), ('дозвонЯтся', 'дозвОнятся', 'verb'), ('премировАть', 'премИровать', 'verb'), ('создалА', 'создАла', 'verb'), ('укрепИт', 'укрЕпит', 'verb'), ('нормировАть', 'нормИровать', 'verb'), ('обзвонИт', 'обзвОнит', 'verb'), ('полилА', 'полИла', 'verb'), ('гналАсь', 'гнАлась', 'verb'), ('лилАсь', 'лИлась', 'verb'), ('баловАться', 'бАловаться', 'verb'), ('облегчИт', 'облЕгчит', 'verb'), ('звонИт', 'звОнит', 'verb'), ('озлОбить', 'озлобИть', 'verb'), ('дождалАсь', 'дождАлась', 'verb'), ('прИбыл', 'прибЫл', 'verb'), ('прибылА', 'прИбыла', 'verb'), ('прИбыло', 'прибЫло', 'verb'), ('избаловАть', 'избАловать', 'verb'), ('отбылА', 'отбЫла', 'verb'), ('бАловень', 'баловЕнь', 'verb'), ('назвалАсь', 'назвАлась', 'verb'), ('щемИть', 'щЕмить', 'verb'), ('щЁлкать', 'щелкАть', 'verb'), ('бралА', 'брАла', 'verb'), ('ободрИшься', 'обОдришься', 'verb'), ('включИт', 'вклЮчит', 'verb'), ('формировАть', 'формИровать', 'verb'), ('освЕдомишься', 'осведомИшься', 'verb'), ('одолжИть', 'одОлжить', 'verb'), ('повторИт', 'повтОрит', 'verb'), ('позвонИшь', 'позвОнишь', 'verb'), ('перезвонИт', 'перезвОнит', 'verb'), ('положИл', 'полОжил', 'verb'), ('убралА', 'убрАла', 'verb'), ('отдалА', 'отдАла', 'verb'), ('отозвалАсь', 'отозвАлась', 'verb'), ('окружИть', 'окрУжить', 'verb'), ('жилОсь', 'жИлось', 'verb'), ('звалА,', 'звАла,', 'verb'), ('одолжИт', 'одОлжит', 'verb'), ('углубИть', 'углУбить', 'verb'), ('позвалА', 'позвАла', 'verb'), ('насорИт', 'насОрит', 'verb'), ('вручИть', 'врУчить', 'verb'), ('зАняли', 'занЯли', 'verb'), ('щемИт', 'щЕмит', 'verb'), ('опОшлить', 'опошлИть', 'verb'), ('закУпорить', 'закупОрить', 'verb'), ('позвонИт', 'позвОнит', 'verb'), ('рвалА', 'рвАла', 'verb'), ('лгалА', 'лгАла', 'verb'), ('нАчали', 'начАли', 'verb'), ('ждалА', 'ждАла', 'verb'), ('опломбировАть', 'опломбИровать', 'verb'), ('положИть', 'полОжить', 'verb'), ('наделИт', 'надЕлит', 'verb'), ('понялА', 'понЯла', 'verb'), ('накренИться', 'накрЕниться', 'verb'), ('оклЕить', 'оклеИть', 'verb'), ('ободралА', 'ободрАла', 'verb'), ('отозвАться', 'отозватьсЯ', 'verb'), ('влИться', 'влитьсЯ', 'verb'), ('крАлась', 'кралАсь', 'verb'), ('наделИть', 'надЕлить', 'verb'), ('зАняло', 'занялО', 'verb'), ('сортировАть', 'сортИровать', 'verb'), ('звонИм', 'звОним', 'verb'), ('ободрИться', 'обОдриться', 'verb'), ('обострИть', 'обОстрить', 'verb'), ('дозвонИтся,', 'дозвОнится,', 'verb'), ('включИшь,', 'вклЮчишь,', 'verb'), ('вручИт', 'врУчит', 'verb'), ('принЯть', 'прИнять', 'verb'), ('навралА', 'наврАла', 'verb'), ('воспринялА', 'воспрИняла', 'verb'), ('понЯть', 'пОнять', 'verb'), ('отозвАть', 'отОзвать', 'verb'), ('звонИшь', 'звОнишь', 'verb'), ('облилАсь', 'облИлась', 'verb'), ('сверлИть', 'свЕрлить', 'verb'), ('включИм', 'вклЮчим', 'verb'), ('позвонИть', 'позвОнить', 'verb'), ('заперлАсь', 'зАперлась', 'verb'), ('облегчИть', 'облЕгчить', 'verb'), ('сорвалА', 'сорвАла', 'verb'), ('сверлИт', 'свЕрлит', 'verb'), ('сверлИшь', 'свЕрлишь', 'verb'), ('откУпорил', 'откупОрил', 'verb'), ('освЕдомиться', 'осведомИться', 'verb'), ('дозвонИться', 'дозвОниться', 'verb'), ('накренИтся', 'накрЕнится', 'verb'), ('влилАсь', 'влИлась', 'verb'), ('откУпорить', 'откупОрить', 'verb'), ('включИть', 'вклЮчить', 'verb'), ('лилА', 'лИла', 'verb'), ('снялА', 'снЯла', 'verb'), ('убыстрИть', 'убЫстрить', 'verb'), ('дозИровать', 'дозировАть', 'verb'), ('заперлА', 'зАперла', 'verb'), ('нАжитый', 'нажИтый', 'participle'), ('низведЁнный', 'низвЕденный', 'participle'), ('снятА', 'снЯта', 'participle'), ('нажИвший', 'нАживший', 'participle'), ('прИнятый', 'принЯтый', 'participle'), ('обострЁнный', 'обОстренный', 'participle'), ('определЁнный', 'опредЕленный', 'participle'), ('зАнятый', 'занЯтый', 'participle'), ('включЁнный', 'вклЮченный', 'participle'), ('заселенА', 'засЕлена', 'participle'), ('сОгнутый', 'согнУтый', 'participle'), ('кровоточАщий', 'кровотОчащий', 'participle'), ('балОванный', 'бАлованный', 'participle'), ('зАпертый', 'запЕртый', 'participle'), ('поделЁнный', 'подЕленный', 'participle'), ('ободрЁн', 'обОдрен', 'participle'), ('занятА', 'зАнята', 'participle'), ('довезЁнный', 'довЕзенный', 'participle'), ('нАчатый', 'начАтый', 'participle'), ('ободрЁнный', 'обОдренный', 'participle'), ('отключЁнный', 'отклЮченный', 'participle'), ('налитА', 'налИта', 'participle'), ('зАгнутый', 'загнУтый', 'participle'), ('заселЁнный', 'засЕленный', 'participle'), ('нажитА', 'нажИта', 'participle'), ('избалОванный', 'избАлованный', 'participle'), ('низведЁн,', 'низвЕден,', 'participle'), ('нанЯвшийся', 'нАнявшийся', 'participle'), ('прожИвший', 'прОживший', 'participle'), ('приручЁнный', 'прирУченный', 'participle'), ('кормЯщий', 'кОрмящий', 'participle'), ('повторЁнный', 'повтОренный', 'participle'), ('понЯвший', 'пОнявший', 'participle'), ('налИвший', 'нАливший', 'participle'), ('включЁн,', 'вклЮчен,', 'participle'), ('молЯщий', 'мОлящий', 'participle'), ('запертА', 'зАперта', 'participle'), ('начАвший', 'нАчавший', 'participle'), ('ободренА', 'обОдрена', 'participle'), ('балУясь', 'бАлуясь', 'gerund'), ('поднЯв', 'пОдняв', 'gerund'), ('начАв', 'нАчав', 'gerund'), ('отдАв', 'Отдав', 'gerund'), ('закУпорив', 'закупОрив', 'gerund'), ('начАвшись', 'нАчавшись', 'gerund'), ('понЯв', 'пОняв', 'gerund'), ('прибЫв', 'прИбыв', 'gerund'), ('донЕльзя', 'дОнельзя', 'adverb'), ('красИвее', 'красивЕе', 'adverb'), ('дОнизу', 'донИзу', 'adverb'), ('навЕрх', 'нАверх', 'adverb'), ('зАгодя', 'загодЯ', 'adverb'), ('зАтемно', 'затемнО', 'adverb'), ('завИдно', 'зАвидно', 'adverb'), ('вОвремя', 'воврЕмя', 'adverb'), ('надОлго', 'нАдолго', 'adverb'), ('добелА', 'дОбела', 'adverb'), ('ненадОлго', 'ненАдолго', 'adverb'), ('зАсветло', 'засвЕтло', 'adverb'), ('дОсуха', 'досУха', 'adverb'), ('дОверху', 'довЕрху', 'adverb')]
